...
IP = "192.168.0.7"  # Camera IP address
PORT = 80  # Port
USER = "admin"  # Username
...
if __name__ == "__main__":
    ...
    ptzControl.move_abspantilt(1,1,0.2)
    time.sleep(3)
    ptzControl.move_abspantilt(-0.9 ,1, 0.2)
    time.sleep(3)
    ptzControl.move_abspantilt(-0.7, 1, 0.2)
    time.sleep(3)
    ptzControl.move_abspantilt(-0.5, 1, 0.2)
    time.sleep(3)
    ptzControl.move_abspantilt(-0.3, 1, 0.2)
    time.sleep(3)
    ptzControl.move_abspantilt(0, 1, 0.2)
    time.sleep(3)
    ptzControl.stop()

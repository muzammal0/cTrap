...
def motion_detection(image_paths, target_mask_path=None, show=True, movement_threshold=2000, max_movement_threshold=3000):
...
def resizeUpload(w,h,fixed_uuid,image_path):
	...
	payload={'uuid':fixed_uuid , 'date' : curr_time }
	headers = {'Authorization': 'Token ea709b06b5af018fd815e051f896dfbd31bd6a29'}
